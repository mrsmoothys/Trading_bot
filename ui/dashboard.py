    ...
    return html.Div([
        ...
        html.Div([
            ...
            html.Div([
                ...
                html.Button('🔔 Setup Alerts', id='setup-alerts-btn', n_clicks=0, style={
                ...
                html.Button('🗑️ Clear Alerts', id='clear-alerts-btn', n_clicks=0, style={
                    'backgroundColor': '#ff4444',
                    'color': 'white',
                    'border': 'none',
                    'padding': '10px 25px',
        ...
        html.Div([
            ...
            html.Div([
                html.Div(id='chat-quick-actions', children=[
                    ...
                    html.Button('⚠️ Risk Assessment', id='chat-risk-assessment', n_clicks=0, style={
                        'backgroundColor': '#2a2a2a', 'color': 'white', 'border': '1px solid #444',
                        'padding': '8px 12px', 'margin': '5px', 'cursor': 'pointer', 'borderRadius': '5px', 'fontSize': '13px'
                    }),
                    ...
                    html.Button('⏸️ Pause Trading', id='chat-pause-trading', n_clicks=0, style={
                        'backgroundColor': '#2a2a2a', 'color': 'white', 'border': '1px solid #444',
                        'padding': '8px 12px', 'margin': '5px', 'cursor': 'pointer', 'borderRadius': '5px', 'fontSize': '13px'
                    }),
                    html.Button('▶️ Resume Trading', id='chat-resume-trading', n_clicks=0, style={
                        'backgroundColor': '#2a2a2a', 'color': 'white', 'border': '1px solid #444',
                        'padding': '8px 12px', 'margin': '5px', 'cursor': 'pointer', 'borderRadius': '5px', 'fontSize': '13px'
                    }),
